...
e:\vm-shared\i386-elf\bin\i386-elf-cpp.exe -P -I. barebox.lds.S -o barebox.lds -DTEXT_BASE=0x7c00 -DCONFIG_X86_HDBOOT
e:\vm-shared\i386-elf\bin\i386-elf-ld.exe -nostdlib -T barebox.lds -Wa,-a=mbr.lst -e _start -o mbr.elf boot_main.o boot_hdisk.o
